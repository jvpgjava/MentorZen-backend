...
public class FeedbackController {
    ...
    @Operation(
            summary = "Buscar feedbacks de uma redação",
            description = "Retorna todos os feedbacks (IA, humano, peer review) de uma redação específica"
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Retorna um feedback específico com análise detalhada por competências"
    )
    @ApiResponses(value = {
    ...
    @GetMapping("/user")
    @Operation(
            summary = "Listar todos os feedbacks do usuário",
            description = "Retorna todos os feedbacks recebidos pelo usuário autenticado, ordenados por data"
    )
    @ApiResponses(value = {
    ...
    @Operation(
            summary = "Estatísticas de desempenho do usuário",
            description = "Retorna estatísticas consolidadas: nota média, número de feedbacks e total de redações"
    )
    @ApiResponses(value = {
